...
const dynamic_matrix<uint8_t> keycode_matrix {{
    ...
    {KEY_LEFTSHIFT, KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B, KEY_BACKSLASH, KEY_RIGHTBRACE, [EY_N, KEY_M, KEY_COMMA, KEY_DOT, KEY_UP, KEY_RIGHTSHIFT},
    {KEY_LEFTCTRL, KEY_LEFTALT, KEY_LEFTMETA, KEY_FN, KEY_INSERT, KEY_SPACE, KEY_NONE, KEY_NONE, KEY_SPACE, KEY_DELETE, KEY_RIGHTALT, KEY_LEFT, KEY_DOWN, KEY_RIGHT}
}};

const dynamic_matrix<uint8_t> fn_matrix {{
    {KEY_NONE, KEY_F1, KEY_F2, KEY_F3, KEY_F4, KEY_F5, KEY_MEDIA_MUTE, KEY_MEDIA_PLAYPAUSE, KEY_F6, KEY_F7, KEY_F8, KEY_F9, KEY_F10, KEY_F11},
    {KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_MEDIA_VOLUMEUP, KEY_MEDIA_NEXTSONG, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_F12},
    ...
    {KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_MEDIA_VOLUMEDOWN, KEY_MEDIA_PREVIOUSSONG, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_PAGEUP, KEY_NONE},
    {KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE, KEY_HOME, KEY_PAGEDOWN, KEY_END}
}};
