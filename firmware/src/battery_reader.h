...
static inline uint8_t sigmoidal(uint16_t voltage, uint16_t min_voltage, uint16_t max_voltage) {
	// slow
	// uint8_t result = 110 - (110 / (1 + pow(1.468 * (voltage - min_voltage)/(max_voltage - min_voltage), 6)));

	// steep
	// uint8_t result = 102 - (102 / (1 + pow(1.621 * (voltage - min_voltage)/(max_voltage - min_voltage), 8.1)));

	// normal
	uint8_t result = 105 - (105 / (1 + pow(1.724 * (voltage - min_voltage)/(max_voltage - min_voltage), 5.5)));
...
static inline uint8_t asigmoidal(uint16_t voltage, uint16_t min_voltage, uint16_t max_voltage) {
	uint8_t result = 101 - (101 / pow(1 + pow(1.33 * (voltage - min_voltage)/(max_voltage - min_voltage) ,4.5), 3));
	return result >= 100 ? 100 : result;
}
